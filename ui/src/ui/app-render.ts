              ...
              <div class="sidebar-brand">
                ${
                  navCollapsed
                    ? nothing
                    : html`
                        <img class="sidebar-brand__logo" src="${agentLogoUrl(basePath)}" alt="AI Assistant" />
                        <span class="sidebar-brand__copy">
                          <span class="sidebar-brand__eyebrow"></span>
                          <span class="sidebar-brand__title">AI Assistant</span>
                        </span>
                      `
                }
              </div>
